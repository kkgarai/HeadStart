...
**Skill name: HeadStart.** This is briefing **on the companion page**. Steps 0–3, the SOD/MID/EOD templates, Hard rules, and Appendix are the briefing skill — copy them, do not summarize them. Additional rules (page, Update calendar on every meeting, RSVP Yes/No/Maybe, Add task, Slack buckets, copyright footer) are in **Step 4b** and **Companion page** only.
